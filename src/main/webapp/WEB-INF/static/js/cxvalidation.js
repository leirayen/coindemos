...
(function (window, undefined) {
    ...
    cxValidation.validateDiv = function (div, options) {
        if (alidation.isJquery(div)) {
            div = div[0];
        }
        if(options){
          if(options.success){
        ...
        var inputs = [].concat(Array.prototype.slice.call(div.querySelectorAll('input')), Array.prototype.slice.call(div.querySelectorAll('textarea')), Array.prototype.slice.call(div.querySelectorAll('select')));
    }
